...
import { View, Text, Modal, TouchableOpacity, ScrollView, Image, ActivityIndicator, TextInput } from 'react-native';
              ...
              <View className="flex-row">
                ...
                <View className="flex-1">
                  <View className="flex-row items-center mb-1">
                    ...
                    <Text className="text-gray-500 text-sm ml-1">@{comment?.user?.username} ·  {formatDate(comment.createdAt)}</Text>
                  </View>
